...
Morrowind is a great game, but can be made ever greater (and less clunky) thanks to 20 years of modding wonderous heritage. While some of the fixes might work on OpenMW these docs focus exclusively on Morrowind.exe and modern Windows systems.
